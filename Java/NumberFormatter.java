...
import Programs.AxisTickCalculator.Direction;
...
class NumberFormatter extends Format {
    ...
    /** Constructor */
    public NumberFormatter(Direction axisDirection, double min, double max) {
     ...
     * @param yIndex
     */
    public NumberFormatter(Direction axisDirection, double min, double max, int yIndex) {
        this.axisDirection = axisDirection;
        this.min = min;
        this.max = max;
        this.yIndex = yIndex;
    ...
    public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
        ...
        String decimalPattern = getFormatPattern(number.doubleValue());
