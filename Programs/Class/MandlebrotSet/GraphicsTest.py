...
mandlebrotDrawMethod = 1 # The method to use to draw the mandlebrot set. 1 = threshold, 2 = gradient, 3 = weird, 4 = gaussian colors, 5 = random colors (very cool looking)
